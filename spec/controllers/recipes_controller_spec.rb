...
RSpec.describe RecipesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: { id: recipe.to_param }, sessions: valid_session
      expect(response).to be_successful
    end
  end
  ...
  # describe "GET #new" do
  #   it "returns a success response" do
  #     get :new, params: {}, sessions: valid_session
  #     expect(response).to be_successful
  #   end
  # end
  # describe "GET #new" do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      recipe = Recipe.create! valid_attributes
      get :edit, params: { id: recipe.to_param }, sessions: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Recipe" do
        expect do
          post :create, params: { recipe: valid_attributes }, sessions: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { recipe: invalid_attributes }, sessions: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested recipe" do
      recipe = Recipe.create! valid_attributes
      expect do
        delete :destroy, params: { id: recipe.to_param }, sessions: valid_session
      end.to change(Recipe, :count).by(-1)
    end
